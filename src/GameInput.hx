...
class GameInput {
	...
	static var kb_mappings = [
		...
		KeyConstant.Lshift => { player: Action.Dodge,       menu: null },
		KeyConstant.Rshift => { player: Action.Dodge,       menu: null },

		KeyConstant.Z         => { player: Action.Shoot,  menu: null },
		KeyConstant.X         => { player: Action.Shield, menu: null },

		KeyConstant.E         => { player: Action.Interact,    menu: null },
		KeyConstant.Return    => { player: Action.Interact,    menu: Action.MenuConfirm },
	...
	static var gp_mappings = [
		GamepadButton.A => { player: Action.Shoot,       menu: Action.MenuConfirm },
		GamepadButton.B => { player: Action.Dodge,       menu: Action.MenuCancel },
		GamepadButton.X => { player: Action.Interact ,   menu: null },
	...
	**/
	...
	public static inline function is_down(gi: Action) {
		return input_state[gi].is_down();
	}
