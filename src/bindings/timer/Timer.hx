...
extern class Timer {
	...
	@:native("tween")
	private static function _tween(len: Float, target: Dynamic, properties: Dynamic, method: TweenMethod): TimerHandle;
	static inline function tween(len: Float, target: Dynamic, properties: Dynamic, method: TweenMethod): TimerHandle {
