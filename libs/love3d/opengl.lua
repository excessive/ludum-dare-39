...
if ffi.os == "Windows" then
	glheader = string.gsub(glheader, "APIENTRYP", "__stdcall *")
	glheader = string.gsub(glheader, "APIENTRY", "__stdcall")
else
	glheader = string.gsub(glheader, "APIENTRYP", "*")
	glheader = string.gsub(glheader, "APIENTRY", "")
end
...
local function constant_replace(name, value)
	...
	if (not num) then
		if string.match(value, "ull$") then
...
glheader = string.gsub(glheader, "#define GL_(%S+)%s+(%S+)\n", constant_replace)
...
local gl_mt = {
	__index = function(self, name)
		...
		local procname = "PFNGL" .. string.upper(name) .. "PROC"
